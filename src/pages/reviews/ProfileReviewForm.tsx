...
import { ArrowLeft, Linkedin, Github, CheckCircle } from "lucide-react";
...
const ProfileReviewForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const { error } = await supabase
        .from('profile_review_submissions')
        .insert({
          full_name: fullName,
          email: email,
          mobile: mobile,
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="pt-24 pb-20">
          <div className="container mx-auto px-6">
            ...
            >
              <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center mx-auto mb-8">
                <CheckCircle className="w-10 h-10 text-white" />
              </div>
              <h1 className="text-3xl md:text-4xl font-bold mb-6">Thank You!</h1>
              <p className="text-lg text-muted-foreground mb-8">
                Our team will review your profiles and contact you shortly with a detailed 
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-20">
        <div className="container mx-auto px-6">
          <Link to="/reviews/profile-review">
          ...
          >
            <div className="text-center mb-12">
              <div className="flex justify-center gap-4 mb-6">
                <div className="w-14 h-14 rounded-2xl bg-[#0077B5] flex items-center justify-center shadow-lg">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">
                Get Your Profiles Reviewed
              </h1>
              <p className="text-lg text-muted-foreground">
                Submit your LinkedIn (and optionally GitHub) for expert review. 
                Receive a rating out of 10 and actionable improvement suggestions.
              </p>
            </div>
            ...
            <div className="bg-card rounded-3xl p-8 md:p-10 border border-border shadow-card">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  size="xl"
                  className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:opacity-90 text-primary-foreground"
